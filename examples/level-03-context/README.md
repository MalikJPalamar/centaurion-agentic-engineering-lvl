...
2. **Audit what your agent sees.** Does the agent have the context it needs? Is it seeing anything irrelevant?
3. **Test information density.** Take a prompt that produced mediocre results. Rewrite it with half the words but the same information.
