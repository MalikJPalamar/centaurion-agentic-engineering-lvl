...
## Getting Started
1. Start with one MCP. Do not connect 15 tools at once.
2. Consider CLI over MCP. MCPs inject full schemas every turn. CLIs only inject output when called.
3. Share skills with your team. Version them like code.
...
- [ ] You have built or customized a skill
- [ ] You have shared a skill with a teammate
